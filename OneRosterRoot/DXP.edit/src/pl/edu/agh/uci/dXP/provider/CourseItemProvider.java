...
/**
 * This is the item provider adapter for a {@link pl.edu.agh.uci.dXP.Course} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CourseItemProvider extends BaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DXPPackage.Literals.COURSE__TITLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DXPPackage.Literals.COURSE__COURSE_CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DXPPackage.Literals.COURSE__CLASS);
		}
	...
	public String getText(Object object) {
		String label = ((Course)object).getCourseCode();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Course.class)) {
			case DXPPackage.COURSE__TITLE:
			case DXPPackage.COURSE__COURSE_CODE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DXPPackage.COURSE__CLASS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DXPPackage.Literals.COURSE__CLASS,
				 DXPFactory.eINSTANCE.createClass()));
	}
