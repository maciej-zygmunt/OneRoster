...
/**
 * This is the item provider adapter for a {@link pl.edu.agh.uci.dXP.Base} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Base_sourceId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Base_sourceId_feature", "_UI_Base_type"),
				 DXPPackage.Literals.BASE__SOURCE_ID,
				 true,
				 false,
				 false,
	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Base_status_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Base_status_feature", "_UI_Base_type"),
				 DXPPackage.Literals.BASE__STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDateLastModifiedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Base_dateLastModified_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Base_dateLastModified_feature", "_UI_Base_type"),
				 DXPPackage.Literals.BASE__DATE_LAST_MODIFIED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DXPPackage.Literals.BASE__METADATA);
		}
	...
	public String getText(Object object) {
		String label = ((Base)object).getSourceId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DXPPackage.Literals.BASE__METADATA,
				 DXPFactory.eINSTANCE.createMetadata()));
	}
